...
unsigned long long Flood::Stream::Read(System::IntPtr buffer, unsigned long long size)
{
...
unsigned long long Flood::Stream::Write(System::IntPtr buffer, unsigned long long size)
{
    auto arg0 = (void*)buffer.ToPointer();
    auto arg1 = (::uint64)size;
...
unsigned long long Flood::Stream::ReadBuffer(System::IntPtr buffer, long long size)
{
    auto arg0 = (void*)buffer.ToPointer();
