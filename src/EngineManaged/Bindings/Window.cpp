...
Flood::RenderContext^ Flood::Window::CreateContext(Flood::RenderContextSettings _35)
{
    auto _marshal0 = ::RenderContextSettings();
    _marshal0.bitsPerPixel = (::uint16)(::uint16_t)_35.BitsPerPixel;
    _marshal0.depthBits = (::uint16)(::uint16_t)_35.DepthBits;
    _marshal0.stencilBits = (::uint16)(::uint16_t)_35.StencilBits;
    _marshal0.antialiasLevel = (::uint16)(::uint16_t)_35.AntialiasLevel;
    auto arg0 = _marshal0;
