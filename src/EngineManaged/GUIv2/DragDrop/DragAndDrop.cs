...
namespace Flood.GUIv2.DragDrop
{
    ...
    public static class DragAndDrop
    {
        ...
        public static IControl SourceControl;

        private static IControl m_LastPressedControl;
        private static IControl m_NewHoveredControl;
        ...
        private static void UpdateHoveredControl(IControl control, int x, int y)
        {
            //
        ...
        public static bool Start(IControl control, Package package)
        {
            if (CurrentPackage != null)
            {
                return false;
        ...
        public static bool OnMouseButton(IControl hoveredControl, int x, int y, bool down)
        {
            if (!down)
            {
                m_LastPressedControl = null;
        ...
        public static void OnMouseMoved(IControl hoveredControl, int x, int y)
        {
        ...
        public static void ControlDeleted(IControl control)
        {
