...
namespace Flood.GUIv2.Input
{
    ...
    public static class InputHandler
    {
        ...
        /// </summary>
        public static IControl HoveredControl;

        /// <summary>
        /// Control that corrently has keyboard focus.
        /// </summary>
        public static IControl KeyboardFocus;

        /// <summary>
        /// Control that currently has mouse focus.
        /// </summary>
        public static IControl MouseFocus;
        ...
        public static bool DoSpecialKeys(IControl canvas, char chr)
        {
        ...
        /// <param name="chr">Input character.</param>
        /// <returns>True if the key was handled.</returns>
        public static bool HandleAccelerator(IControl canvas, char chr)
        {
        ...
        /// <param name="dx"></param>
        /// <param name="dy"></param>
        public static void OnMouseMoved(IControl canvas, int x, int y, int dx, int dy)
        {
        ...
        public static void OnCanvasThink(IControl control)
        {
            ...
            for (var iKey = 0; iKey < (int)Keys.MAX; iKey++)
            {
                ...
                if (m_KeyData.KeyState[iKey] && time > m_KeyData.NextRepeat[iKey])
                {
                    ...
                    {
                        ((IControl)KeyboardFocus).InputKeyPressed((Keys)iKey);
                    }
                }
            }
        }
        ...
        public static bool OnMouseClicked(IControl canvas, int mouseButton, bool down)
        {
        ...
        /// <returns>True if handled.</returns>
        public static bool OnKeyEvent(IControl canvas, Keys key, bool down)
        {
            if (null == KeyboardFocus) return false;
            if (KeyboardFocus.GetCanvas() != canvas) return false;
            if (!KeyboardFocus.IsVisible) return false;
        ...
        private static void UpdateHoveredControl(IControl inCanvas)
        {
            IControl hovered = inCanvas.GetControlAt(MousePosition.X, MousePosition.Y);
        ...
        private static void FindKeyboardFocus(IControl control)
        {
