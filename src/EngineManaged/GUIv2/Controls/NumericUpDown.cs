...
namespace Flood.GUIv2.Controls
{
    ...
    public class NumericUpDown : TextBoxNumeric
    {
            ...
            : base(parent)
        {
            ...
            //m_Splitter.Alignment = AlignmentFlags.Right;
        ...
        /// </summary>
        public event Control.GwenEventHandler ValueChanged;
        ...
        protected virtual void OnButtonUp(IControl control)
        {
            Value = m_Value + 1;
        }
        ...
        /// </summary>
        /// <param name="control">Event source.</param>
        protected virtual void OnButtonDown(IControl control)
        {
            Value = m_Value - 1;
        }
        ...
        public override float Value
        {
            ...
            set
            {
                ...
                if (Math.Abs(value - m_Value) < float.Epsilon) return;
