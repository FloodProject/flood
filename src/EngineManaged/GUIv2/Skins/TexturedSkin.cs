...
using Flood.GUIv2.Skins.Texturing;
...
namespace Flood.GUIv2.Skins
{
    ...
    public class TexturedSkin : Skin
    {
        ...
        #region UI elements
        public override void DrawButton(IControl control, bool depressed, bool hovered, bool disabled)
        {
            if (disabled)
            {
        ...
        public override void DrawMenuRightArrow(IControl control)
        {
            Textures.Menu.RightArrow.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawMenuItem(IControl control, bool submenuOpen, bool isChecked)
        {
        ...
        public override void DrawMenuStrip(IControl control)
        {
            Textures.Menu.Strip.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawMenu(IControl control, bool paddingDisabled)
        {
            if (!paddingDisabled)
            {
        ...
        public override void DrawShadow(IControl control)
        {
        ...
        public override void DrawRadioButton(IControl control, bool selected, bool depressed)
        {
            if (selected)
            {
        ...
        public override void DrawCheckBox(IControl control, bool selected, bool depressed)
        {
            if (selected)
            {
                if (control.IsDisabled)
        ...
        public override void DrawGroupBox(IControl control, int textStart, int textHeight, int textWidth)
        {
        ...
        public override void DrawTextBox(IControl control)
        {
            if (control.IsDisabled)
            {
        ...
        public override void DrawTabButton(IControl control, bool active, AlignmentFlags alignment)
        {
            if (active)
            {
                DrawActiveTabButton(control, alignment);
                return;
            }
        ...
        public override void DrawTabControl(IControl control)
        {
            Textures.Tab.Control.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTabTitleBar(IControl control)
        {
            Textures.Tab.HeaderBar.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawWindow(IControl control, int topHeight, bool inFocus)
        {
            if (inFocus) 
        ...
        public override void DrawHighlight(IControl control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawScrollBar(IControl control, bool horizontal, bool depressed)
        {
            if (horizontal)
        ...
        public override void DrawScrollBarBar(IControl control, bool depressed, bool hovered, bool horizontal)
        {
            if (!horizontal)
            {
                if (control.IsDisabled)
        ...
        public override void DrawProgressBar(IControl control, bool horizontal, float progress)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawListBox(IControl control)
        {
            Textures.Input.ListBox.Background.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawListBoxLine(IControl control, bool selected, bool even)
        {
            if (selected)
            {
                if (even)
        ...
        public override void DrawSlider(IControl control, bool horizontal, int numNotches, int barSize)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawComboBox(IControl control, bool down, bool open)
        {
            if (control.IsDisabled)
            {
        ...
        public override void DrawKeyboardHighlight(IControl control, Rectangle r, int offset)
        {
            Rectangle rect = r;
        ...
        public override void DrawToolTip(IControl control)
        {
            Textures.Tooltip.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawScrollButton(IControl control, Pos direction, bool depressed, bool hovered, bool disabled)
        {
            int i = 0;
        ...
        public override void DrawComboBoxArrow(IControl control, bool hovered, bool down, bool open, bool disabled)
        {
            if (disabled)
            {
        ...
        public override void DrawNumericUpDownButton(IControl control, bool depressed, bool up)
        {
            if (up)
            {
                if (control.IsDisabled)
        ...
        public override void DrawStatusBar(IControl control)
        {
            Textures.StatusBar.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTreeButton(IControl control, bool open)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawTreeControl(IControl control)
        {
            Textures.Tree.Background.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawTreeNode(IControl ctrl, bool open, bool selected, int labelHeight, int labelWidth, int halfWay, int lastBranch, bool isRoot)
        {
            if (selected)
            {
        ...
        public override void DrawColorDisplay(IControl control, Color color)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawModalControl(IControl control)
        {
        ...
        public override void DrawMenuDivider(IControl control)
        {
            Rectangle rect = control.RenderBounds;
            Renderer.DrawColor = new Color(0, 0, 0, 100);
            Renderer.DrawFilledRect(rect);
        ...
        public override void DrawWindowCloseButton(IControl control, bool depressed, bool hovered, bool disabled)
        {
        ...
        public override void DrawSliderButton(IControl control, bool depressed, bool horizontal)
        {
            if (!horizontal)
            {
                if (control.IsDisabled)
        ...
        public override void DrawCategoryHolder(IControl control)
        {
            Textures.CategoryList.Outer.Draw(Renderer, control.RenderBounds);
        }

        public override void DrawCategoryInner(IControl control, bool collapsed)
        {
            if (collapsed)
