...
namespace Flood.GUIv2.Skins
{
    ...
    public class Simple : Skin
    {
        ...
        public override void DrawKeyboardHighlight(IControl control, Rectangle r, int iOffset)
        {
            Rectangle rect = r;
        ...
        public override void DrawComboBoxArrow(IControl control, bool hovered, bool depressed, bool open, bool disabled)
        {
