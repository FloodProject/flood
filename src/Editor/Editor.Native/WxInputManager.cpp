...
Keyboard* WxInputManager::getKeyboard()
{
    return &keyboard;
}
...
void WxInputManager::processKeyEvent(Keyboard* keyboard, const wxKeyEvent& event,
                                     bool isKeyDown)
{
...
void WxInputManager::processCharEvent(Keyboard* keyboard, const wxKeyEvent& event)
{
...
void WxInputManager::processMouseEvent(Mouse* mouse, const wxMouseEvent& event)
{
#if 0
...
static MouseButton ConvertFromWxMouseButton( const wxMouseEvent& event )
{
    ...
    fld_unreachable("Unknown wxWidgets button kind");
}
