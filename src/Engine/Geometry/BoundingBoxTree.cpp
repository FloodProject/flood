...
typedef Vector< uint32 > TriVector;
...
public:
...

    {
        ...
        { 
            ...
            leafTriangles.Push(count);
            for (TriVector::ConstIterator i=triangles.begin(); i!=triangles.end(); ++i)
            {
                leafTriangles.Push( *i );
            }
        }
        else
        {
            ...
            for (TriVector::ConstIterator i=triangles.begin(); i!=triangles.end(); ++i)
            {
...

                {
                    ...
                    if ( b1.containsTriangle(p1,p2,p3))
                    {
                        ...
                        leftTriangles.Push(tri); // Add this triangle to the 'left triangles' array and revise the left triangles bounding volume
                    }
                    ...
                    if ( b2.containsTriangle(p1,p2,p3))
                    {
                        ...
                        rightTriangles.Push(tri); // Add this triangle to the 'right triangles' array and revise the right triangles bounding volume.
                    }
                }
            }
