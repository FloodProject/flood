...
#endif
#else	/* inserted to prevent a compiler error about initializing an array of
			variable length with zero elements	*/
	0
#endif
};
...
#else
	const int total = 0;	/* don't loop over elements that aren't there */
#endif
