	...
	"<html xmlns='http://www.w3.org/1999/xhtml'>\n"
		...
		"<body>\n"
			"\t<div id='container' align='center'>\n"
				"\t<img id='header' src='head.png' alt='header'/>\n"
				"\t<table class='sortable'>\n"
					"\t\t<thead>\n"
						"\t\t\t<tr><th></th><th>Date</th><th>Subsystem</th><th>Description</th></tr>\n"
					"\t\t</thead>\n";

/**
 * CSS styling used in the HTML log format.
 */
static const char LOG_CSS[] =
	...
	"\t\t\ttable { margin: 0px; table-layout: automatic; width: 600px; text-align: left; border: 1px solid black; }\n"
	"\t\t\tthead th { font-weight: bold; font-size: 120%; border-bottom: 1px dotted black; }\n"
	"\t\t\ttable tr.even td { background-color: #eee; }\n"
	"\t\t\ttable td.warn tr { background-color: #ff9; }\n"
	"\t\t\ttable td.info { background-repeat: no-repeat; width: 16px; background-image: url('data:image/png;base64,'); }\n"
	"\t\t\ttable td.warn { background-repeat: no-repeat; width: 16px; background-image: url('data:image/png;base64,'); }\n"
	"\t\t\ttable td.error { background-repeat: no-repeat; width: 16px; background-image: url('data:image/png;base64,'); }\n";
