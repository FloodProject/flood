...
public:
	...
	void Insert(Vector<Vector2i> &rects, Vector<Rectangle> &dst, FreeRectChoiceHeuristic method);
...
private:
	...
	Vector<Rectangle> usedRectangles;
	...
	Rectangle ScoreRect(int width, int height, FreeRectChoiceHeuristic method, int &score1, int &score2) const;
	...
	Rectangle FindPositionForNewNodeBottomLeft(int width, int height, int &bestY, int &bestX) const;
	Rectangle FindPositionForNewNodeBestShortSideFit(int width, int height, int &bestShortSideFit, int &bestLongSideFit) const;
	Rectangle FindPositionForNewNodeBestLongSideFit(int width, int height, int &bestShortSideFit, int &bestLongSideFit) const;
	Rectangle FindPositionForNewNodeBestAreaFit(int width, int height, int &bestAreaFit, int &bestShortSideFit) const;
	Rectangle FindPositionForNewNodeContactPoint(int width, int height, int &contactScore) const;
