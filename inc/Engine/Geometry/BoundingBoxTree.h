...
class API_SCENE BoundingBoxTree
{
public:

	virtual bool raycast(const Ray&,
        float *hitLocation,float *hitNormal,float *hitDistance) = 0;
...
API_SCENE BoundingBoxTree* CreateBoundingBoxTree(
    const Array<Vector3>& vertices, Array<uint16> indices);
