...
namespace UnicodeConversionResult
{
	enum Enum
	{
...
UnicodeConversionResult::Enum ConvertUCS4toUTF16 (
		UCS4** sourceStart, const UCS4* sourceEnd, 
		UTF16** targetStart, const UTF16* targetEnd);

UnicodeConversionResult::Enum ConvertUTF16toUCS4 (
...
UnicodeConversionResult::Enum ConvertUCS4toUTF8 (
		UCS4** sourceStart, const UCS4* sourceEnd, 
		UTF8** targetStart, const UTF8* targetEnd);
		
UnicodeConversionResult::Enum ConvertUTF8toUCS4 (
