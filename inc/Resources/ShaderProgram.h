...
REFLECT_DECLARE_CLASS(ShaderProgram)

class API_RESOURCE ShaderProgram : public Resource
{
	REFLECT_DECLARE_OBJECT(ShaderProgram)
...
TYPEDEF_RESOURCE_HANDLE_FROM_TYPE( ShaderProgram );
